 ...
 */
RKH_CREATE_COMP_STATE( UTST, NULL, NULL,  RKH_ROOT, &S1, NULL );
RKH_CREATE_TRANS_TABLE( UTST )

	RKH_TRINT( SIX, 	NULL, 		show_data ),
	RKH_TRINT( TERM, 	NULL, 		terminate ),
	RKH_TRINT( UCLEAN, 	NULL, 		unit_clean ),
	RKH_TRINT( UTEST, 	NULL, 		unit_test ),

RKH_END_TRANS_TABLE


RKH_CREATE_BASIC_STATE( S2, NULL, NULL,  &UTST, NULL );
...
RKH_CREATE_COMP_STATE( S1, set_y_0, dummy_exit,  &UTST, &S11, &DH );
...
RKH_CREATE_COMP_STATE( S3, NULL, NULL,  &UTST, &S31,  NULL );
