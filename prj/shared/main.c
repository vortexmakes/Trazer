...
main( int argc, char *argv[] )
{
	...
	RKH_TR_FWK_FUN( &svr_init );
	RKH_TR_FWK_FUN( &svr_pause );
	RKH_TR_FWK_FUN( &svr_resume );
	RKH_TR_FWK_FUN( &svr_start );	
	RKH_TR_FWK_FUN( &svr_end );
	RKH_TR_FWK_FUN( &svr_defer );
	RKH_TR_FWK_FUN( &svr_terminate );

	RKH_TR_FWK_FUN( &cli_init );
	RKH_TR_FWK_FUN( &cli_delay_req );
	RKH_TR_FWK_FUN( &cli_pause );
	RKH_TR_FWK_FUN( &cli_resume );
	RKH_TR_FWK_FUN( &cli_req );
	RKH_TR_FWK_FUN( &cli_start );
	RKH_TR_FWK_FUN( &cli_end );
